...
class BasicFlying : public vd::Dynamics {
...
private:
	...
	// function pointers ----------------------------------------------------------------------------------------------
		...
		boost::function<void (const Long& nid, const Long& time, const Long& timestep)> _initBasicFlying;
	
	
	// interactions ----------------------------------------------------------------------------------------------
	
	void interaction_initBasicFlying(const vd::Time& time) {
		TraceAlways(vu::DateTime::simpleCurrentDate() + " - BasicFlying::interaction_initBasicFlying - request at time : " + time.toString());
		try
		{
			_initBasicFlying(this->NID,this->time,this->timestep);
		}
		catch(...)
		{
			TraceAlways(vu::DateTime::simpleCurrentDate() + " - BasicFlying::interaction_initBasicFlying - Error in calling function initBasicFlying at time : " + time.toString());
		}
	}
	...
	bool guard_initializing(const vd::Time& time) const {
		TraceAlways(vu::DateTime::simpleCurrentDate() + " - BasicFlying::guard_initializing - request at time : " + time.toString());
		bool result = true;
		result &= (this->time==0); 
		return result;
	};
	...
	void action_test2 (const vd::Time& time) {
		TraceAlways(vu::DateTime::simpleCurrentDate() + " - BasicFlying::action_test2 - request at time : " + time.toString());
		this->_signal_test2 = true; }
	
	// Transitions -------------------------------------------------------------------------------------------------------
	
	void transition_INIT_to_RUNNING_for_ModelState(const vd::Time& time) {
		TraceAlways(vu::DateTime::simpleCurrentDate() + " - BasicFlying::transition_INIT_to_RUNNING_for_ModelState] - request at time : " + time.toString());
...
public:
	...
	BasicFlying(const vd::DynamicsInit& init, const vd::InitEventList& events) : vd::Dynamics(init, events) {
		TraceAlways(vu::DateTime::simpleCurrentDate() + " - BasicFlying::BasicFlying");
	...
	virtual vd::Time init(const vd::Time& time) {
		TraceAlways(vu::DateTime::simpleCurrentDate() + " - BasicFlying - Init at time : " + time.toString());
	
	_initBasicFlying = (void (*)(const Long& nid, const Long& time, const Long& timestep)) _pFuncDirectory->getFunction("initBasicFlying");
	...
	virtual void output(const vd::Time& time, vd::ExternalEventList& output) const {
		TraceAlways(vu::DateTime::simpleCurrentDate() + " - BasicFlying - Output at time : " + time.toString());
	...
	virtual void internalTransition(const vd::Time& time) {
		TraceAlways(vu::DateTime::simpleCurrentDate() + " - BasicFlying - internal transition at time : " + time.toString());
		switch(this->_ModelState_state) {
		case INIT:
			transition_INIT_to_RUNNING_for_ModelState(time);
			interaction_initBasicFlying(time);
	...
	virtual void externalTransition(const vd::ExternalEventList& eventList, const vd::Time& time) {
		TraceAlways(vu::DateTime::simpleCurrentDate() + " - BasicFlying - externalTransition at time : " + time.toString());
		//Update input port 
	...
	virtual vv::Value* observation(const vd::ObservationEvent& event) const {
		TraceAlways(vu::DateTime::simpleCurrentDate() + " - BasicFlying - observation");
...
DECLARE_DYNAMICS(generated::BasicFlying)
